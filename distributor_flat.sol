...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BUSD = IERC20(0x0078867bbeef44f2326bf8ddd1941a4439382ef2a7); //TESTNET
    ...
    function setAllowed(address _address, bool _allow) external onlyAllowed {
        require(_address != msg.sender);
        _allowed[_address] = _allow;
    }

    function setDistributionCriteria(uint256 _minPeriod, uint256 _minDistribution) external override onlyAllowed {
