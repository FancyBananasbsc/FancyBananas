...
contract FancyBanana is ERC20, Ownable {
    ...
    constructor(address _distributor) ERC20("FANCY BANANA$", "BANANA$", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x11519BfBfBC6459aF842b62d2E8789B0f6723632;
        treasuryReceiver = 0x477E921aBa16c4Bd0f11296D2123D80bcC1875F6;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no $BANANA token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return
            (TOTAL_GONS.sub(_gonBalances[ZERO])).div(
                _gonsPerFragment
            );
    }
